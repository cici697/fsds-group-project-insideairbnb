...
1. There are some Airbnb listings in London are illegal, according to the Deregulation Act 2015.
2. Airbnb caused the increase of housing price in London and negatively impacted the supply of long-term housing rent in London, which are arsing the housing crisis in London.
3. The density of Airbnb in London is not "normal", especially in boroughs like Westerminster.

We start the analysis from the legal investigation:
...
# 90-day cap
# We will use literature review to state the situation
```

Next, we investiagte the situation of Airbnb density in London. We put a cap of 10% of total private housing, as this is regarded as a permit to ensure sufficient housing supply for residences in local districts in Amsterdam, according to the Amsterdam Short Stay Policy.

But, we first map the distribution of each type of room on Airbnb in London to have a general understanding. To generate this map, we need to convert the data with columns of longitude and latitude into a geometry one with a geometry column.
...
"Professional hosts are profit-oriented players who behave close to business corporations, while non-professional hosts primarily engage in sharing-oriented supply" (Boto-García, 2025, p.6). The distinction between the two is generally based on the number of accommodations offered and the type of rooms they provided.
